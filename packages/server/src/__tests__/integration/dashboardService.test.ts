...
describe('Dashboard Service Integration Tests', () => {
  ...
  it('should get dashboard summary', async () => {
    // Create test data
    await moodService.createMood(userId, { date: '2024-08-01', moodScore: 7, emotions: ['happy'] });
    await journalEntryService.createJournalEntry(userId, { date: '2024-08-01', entry: 'Great day!' });
    await activityService.createActivity(userId, { date: '2024-08-01', activity: 'Running', duration: 30 });
